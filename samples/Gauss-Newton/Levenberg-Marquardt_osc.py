...
# ダンピングファクタの初期値，更新倍率
LAMBDA_0 = 0.01   # Value of MatLab's InitDamping, LAMBDA_0 >= 0
LAMBDA_v = 10.0   # LAMBDA_v > 1
...
def calc_next_beta( ess_file, target_data_dict, beta_dict, delta = 0.01, lam = 0.0, other_files = [] ):
