...
from ecell.ui.model_editor.Clipboard import *
...
from ecell.ui.model_editor.CommandQueue import * 
...
from ecell.ui.model_editor.MEMainWindow import *
from ecell.ui.model_editor.StepperTab import *
from ecell.ui.model_editor.EntityListTab import *
from ecell.ui.model_editor.ClassEditorWindow import *
from ecell.ui.model_editor.DMInfo import *
from ecell.ui.model_editor.PopupMenu import *
from ecell.ui.model_editor.PathwayEditor import *
from ecell.ui.model_editor.LayoutManager import *
from ecell.ui.model_editor.AboutModelEditor import *
from ecell.ui.model_editor.CommandMultiplexer import *
from ecell.ui.model_editor.ObjectEditorWindow import *
from ecell.ui.model_editor.ConnectionObjectEditorWindow import *
from ecell.ui.model_editor.LayoutEml import *
from ecell.ui.model_editor.GraphicalUtils import *
from ecell.ui.model_editor.LayoutBufferFactory import *
from ecell.ui.model_editor.Error import *
import ecell.ui.model_editor.AutosaveWindow as AutosaveWindow
from ecell.ui.model_editor.Runtime import *

RECENTFILELIST_FILENAME = '.recentlist'
...
class ModelEditor:
    ...
    def __init__( self, aFileName = None ):
        ...
        self.theIniFileName = os.path.join( home_dir, '.ecell', 'model-editor.ini' )
        theDefaultIniFileName = os.path.join( conf_dir, 'model-editor.ini' )
...
#        t=[["start", time.time()]]      
    ...
    def __loadRecentFileList( self ):
        ...
        aFileName = os.path.join( home_dir, '.ecell', RECENTFILELIST_FILENAME )
    ...
    def __saveRecentFileList( self ):
        ...
        # creates file 
        aFileName = os.path.join( home_dir, '.ecell', RECENTFILELIST_FILENAME )
        aDirName = os.path.dirname( aFileName ) 
...
#####################################################################################################################   
    ...
    def __readIni(self,aPath):
        """read model-editor.ini file
        an model-editor.ini file may be in the given path
        ...
        aFilename = os.path.join( aPath, '.ecell', 'model-editor.ini' )
        if not os.path.isfile( aFilename ):
            # self.message('There is no model-editor.ini file in this directory.\n Falling back to system defauls.\n')
            return None

        # tries to read file

        try:
            self.message('Reading model-editor.ini file from directory [%s]' %aPath)
