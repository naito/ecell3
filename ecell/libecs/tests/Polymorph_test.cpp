...
std::string stream_tester( Polymorph const& a )
{
    std::stringstream s;
    s << a;
    return s.str();
...
{
    BOOST_CHECK_EQUAL( Polymorph( 1.0 ), Polymorph( 1.0 ) );
    BOOST_CHECK_EQUAL( 1.0, Polymorph( 1.0 ) );
    BOOST_CHECK_EQUAL( Polymorph( 1.0 ), 1.0 );

    BOOST_CHECK_EQUAL( Polymorph( 1l ), Polymorph( 1l ) );
    BOOST_CHECK_EQUAL( 1l, Polymorph( 1l ) );
    BOOST_CHECK_EQUAL( Polymorph( 1l ), 1l );

    BOOST_CHECK_EQUAL( Polymorph( 1l ), Polymorph( 1.0 ) );
    BOOST_CHECK_EQUAL( Polymorph( 1.0 ), Polymorph( 1l ) );
    BOOST_CHECK_EQUAL( 1.0, Polymorph( 1l ) );
    BOOST_CHECK_EQUAL( 1l, Polymorph( 1.0 ) );
    BOOST_CHECK_EQUAL( Polymorph( 1l ), 1.0 );
    BOOST_CHECK_EQUAL( Polymorph( 1.0 ), 1l );
